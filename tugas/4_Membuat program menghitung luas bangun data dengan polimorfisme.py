...
# Definikan kelas dasar Shape
class Shape:
    def hitung_luas(self):
        pass

# Definikan kelas turunan Square yang mewarisi dari Shape
class Square(Shape):
...
# Definikan kelas turunan Circle yang mewarisi dari Shape
class Circle(Shape):
...
# Definikan kelas turunan Triangle yang mewarisi dari Shape
